######################################################
# CONFIGURE YOUR TOOLS HERE (secrets.py)
######################################################

# Login Credentials for LinkedIn (Optional)
username = "admin@admin.com"         # Enter your username in the quotes
password = "adminadmin"         # Enter your password in the quotes
...
CHECK THE OPENAI API PRICES AT THEIR WEBSITE (https://openai.com/api/pricing/).
'''
...
deepseek_api_url = ""     # Examples: "https://api.deepseek.com", "https://api.deepseek.com/v1"
'''
...
deepseek_api_key = ""     # Enter your DeepSeek API key in the quotes
'''
...
llm_api_url = ""               # Examples: "https://api.openai.com/v1/", "http://127.0.0.1:1234/v1/", "http://localhost:1234/v1/"
'''
...
# # Your local embedding model name or other AI Embedding model name
